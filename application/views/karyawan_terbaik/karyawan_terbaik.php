						...
						<form name="rekap_form" method="post" action="<?php echo $form_action; ?>">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<div class="notification attention png_bg">
									...
									<div>
										Halaman ini digunakan untuk rekap kehadiran dalam sebulan. Untuk menutup notifikasi ini klik tanda silang pada pojok kanan atas.
									</div>
								</div>	
								
								<p>
									<label for="id_kelas">Rekap Presensi Per Bulan :</label>
