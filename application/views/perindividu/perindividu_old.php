						...
						<form name="rekap_form" method="post" action="<?php echo $form_action; ?>">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<div class="notification attention png_bg">
									<a class="close" href="#"><img alt="close" title="Close this notification" src="http://192.168.0.1/gph//asset/images/icons/cross_grey_small.png"></a>
									<div>
										Halaman ini digunakan untuk rekap kehadiran per individu dalam sebulan. Untuk menutup notifikasi ini klik tanda silang pada pojok kanan atas.
									</div>
								</div>
