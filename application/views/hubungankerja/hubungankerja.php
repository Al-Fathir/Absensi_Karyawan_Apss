					...
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<p>
							...
							<select name="field" id="field">
								<option value="hubungankerja.nik">NIK</option>
								<option value="karyawan.nama_karyawan">Nama Karyawan</option>
								<option value="hubungankerja.tanggal_masuk">Tanggal Awal Kontrak</option>
								<option value="hubungankerja.tanggal_keluar">Tanggal Akhir Kontrak</option>
							</select>
							<input type="text" value="" name="kunci" id="kunci" class="text-input small-input">
							<?php echo form_dropdown('status_kontrak', $options_kontrak, isset($default['status_kontrak']) ? $default['status_kontrak'] : ''); ?>
