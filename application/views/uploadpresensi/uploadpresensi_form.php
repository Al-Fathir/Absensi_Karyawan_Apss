<div class="content-box"><!-- Start Content Box -->
			...
			<div class="tab-content default-tab">
					...
					?>
						...
						<?php echo form_open_multipart('uploadpresensi/do_upload_presensi');?>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<div class="notification attention png_bg">
									...
									<div>
										Halaman ini digunakan untuk upload data presensi dengan format file excel. Untuk menutup notifikasi ini klik tanda silang pada pojok kanan atas.
									</div>
								</div>
								
								<p>
									<label>Upload Presensi</label>
