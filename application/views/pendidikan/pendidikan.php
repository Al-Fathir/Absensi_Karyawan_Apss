					...
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<p>
							...
							<select name="field" id="field">
								<option value="pendidikan.nik">NIK</option>
								<option value="karyawan.nama_karyawan">Nama Karyawan</option>
								<option value="pendidikan.nama_sekolah">Nama Sekolah</option>
								<option value="pendidikan.tahun_masuk">Tahun Masuk</option>
								<option value="pendidikan.tahun_lulus">Tahun Lulus</option>
							</select>
							<input type="text" value="" name="kunci" id="kunci" class="text-input small-input">
							<?php echo form_dropdown('jenjang', $options_jenjang, isset($default['jenjang']) ? $default['jenjang'] : ''); ?>
